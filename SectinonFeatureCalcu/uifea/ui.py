...
# Form implementation generated from reading ui file 'uifea.ui'
#
...
import base64
from images import SubChangeimg

class Ui_Form(object):
    def setupUi(self, Form):
        Form.setObjectName("Form")
        Form.resize(850, 800)
        Form.setMinimumSize(QtCore.QSize(850, 800))
        Form.setMaximumSize(QtCore.QSize(850, 800))
        self.tableView = QtWidgets.QTableView(Form)
        self.tableView.setGeometry(QtCore.QRect(495, 90, 291, 541))
        self.tableView.setObjectName("tableView")
        self.label_20 = QtWidgets.QLabel(Form)
        self.label_20.setGeometry(QtCore.QRect(497, 46, 125, 25))
        font = QtGui.QFont()
        font.setFamily("宋体")
        ...
        self.label_11.setGeometry(QtCore.QRect(57, 42, 125, 25))
        font = QtGui.QFont()
        font.setFamily("宋体")
        font.setPointSize(15)
        ...
        self.pushButton_1.setGeometry(QtCore.QRect(590, 660, 93, 28))
        self.pushButton_1.setObjectName("pushButton_1")
        self.layoutWidget = QtWidgets.QWidget(Form)
        self.layoutWidget.setGeometry(QtCore.QRect(56, 81, 381, 315))
        ...
        self.label_5.setGeometry(QtCore.QRect(50, 420, 380, 330))
        self.label_5.setMinimumSize(QtCore.QSize(380, 330))
        self.label_5.setMaximumSize(QtCore.QSize(380, 330))
        self.label_5.setText("")
        #MainDir,MainFile=os.path.split(os.path.abspath(sys.argv[0]))  #获取主执行文件所处的文件夹的绝对路径及文件名
        #SubChangeimgDir=os.path.normpath(os.path.join(MainDir,'img/SubChangeimg.jpg'))
        tmp = open("tmp.jpg","wb+")
        tmp.write(base64.b64decode(SubChangeimg))
        tmp.close()
        self.label_5.setPixmap(QtGui.QPixmap("tmp.jpg"))
    ...
    def retranslateUi(self, Form):
        ...
        self.label_20.setText(_translate("Form", "截面特性："))
        self.label_11.setText(_translate("Form", "主要尺寸："))
        self.pushButton_1.setText(_translate("Form", "calculate"))
        self.label.setText(_translate("Form", "b1:"))
        self.label_2.setText(_translate("Form", "mm"))
        self.label_12.setText(_translate("Form", "h1:"))
        self.label_13.setText(_translate("Form", "mm"))
        self.label_3.setText(_translate("Form", "b2:"))
        self.label_4.setText(_translate("Form", "mm"))
        self.label_14.setText(_translate("Form", "h2:"))
        self.label_15.setText(_translate("Form", "mm"))
        self.label_25.setText(_translate("Form", "b3:"))
        self.label_6.setText(_translate("Form", "mm"))
        self.label_16.setText(_translate("Form", "h3:"))
        self.label_17.setText(_translate("Form", "mm"))
        self.label_7.setText(_translate("Form", "b4:"))
        self.label_8.setText(_translate("Form", "mm"))
        self.label_18.setText(_translate("Form", "h4:"))
        self.label_19.setText(_translate("Form", "mm"))
        self.label_9.setText(_translate("Form", "b5:"))
        self.label_10.setText(_translate("Form", "mm"))
        self.label_21.setText(_translate("Form", "h5:"))
        self.label_22.setText(_translate("Form", "mm"))
        self.label_23.setText(_translate("Form", "b6:"))
